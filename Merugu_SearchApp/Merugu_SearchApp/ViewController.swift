...
class ViewController: UIViewController {
    ...
    var car_keywords = ["Model", "indianbrand", "milegecar", "offroadingcar", "formulacar"]
    var flower_keywords = ["beautifulplant", "smellable", "seedplant", "winterplant" , "springflower"]
    var animals_keywords = ["cuteanimal", "water horse", "jungleking", "buck", "trunk"]
